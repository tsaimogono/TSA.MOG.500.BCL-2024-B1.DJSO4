...
export const htmlElements = {
    list: {
        // Selecting list-related HTML elements
    ...
    setting: {
        // Selecting setting-related HTML elements
